...
@section('content')
        ...
        <div class="page-title-wrapper">
            <div class="section-bg" style="background-image: url({{url('./img/slider/sliderEndo.jpg')}});"></div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
                    ...
                    <div class="col-md-6">
                        <div class="features-entry margin-bottom-0 wow fadeInRight">
                            <div class="image-holder margin-bottom-0">
                                ...
                                <img width="800" height="500" src="{{asset ('./img/post/postEndo.jpg')}}" alt="">
                                            ...
                                            <ul>
                                                ...
                                                <li class="interest-point" style="top: 32%; left: 18%;">
                                                    ...
                                                    <div class="car-more-info car-right">
                                                        <img class="car-more-image" src="{{asset ('./img/box/boxEndo2.jpg')}}" alt=""/>
                                                        <h3>Intubation</h3>
                                                        <ul>
                                                            <li>- BVM</li>
                                                            <li>- Laryngoscope</li>
                                                ...
                                                <li class="interest-point" style="top: 38%;right: 61%;">
                                                    ...
                                                    <div class="car-more-info car-left">
                                                        <img class="car-more-image" src="{{asset ('./img/box/boxEndo3.jpg')}}" alt=""/>
        ...
        <section class="dark-section"> 
            ...
            <div class="interior-container">
                        ...
                        <div class="row gallery">
                            ...
                            <div class="col-md-3 wow fadeIn" data-wow-delay=".3s">
                                <div class="image-holder">
                                        ...
                                        <img src="{{asset ('./img/gallery/gallery-interiorEndo.jpg')}}" alt="">
                            ...
                            <div class="col-md-3 wow fadeIn" data-wow-delay=".9s">
                                ...
                                <a href="{{asset ('./img/gallery/gallery-interiorEndo.jpg')}}" class="image-link"></a>
                            </div>
                        </div>
                        <div class="mid-space"></div>
                    </div>
                ...
                <div class="car-interest">
                    <div class="car-interest-wrapper">
                        <div class="interior-bg" style="background-image: url('{{asset ('./img/slider/sliderEndo.jpg')}}');"></div>
        ...
        <section class="page-title-wrapper">
            <div class="section-bg-bottom" style="background-image: url({{url('./img/slider/sliderEndo.jpg')}}); background-position: 10% 71px;">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
